...
const {add, create, edit, update, delete:remove, destroy, list, new:newest, recomended, detail, search} = require('../controllers/moviesController');
...
router.get('/movies', list)
    ...
    .put('/movies/update/:id', upload.single('image'), movieEditValidator,update)
